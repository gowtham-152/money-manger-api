...
import { Plus, TrendingDown, Calendar, RefreshCw, Trash2 } from 'lucide-react';
...
export function ExpensePage({ transactions, categories, addTransaction, deleteTransaction, onRefresh }: ExpensePageProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-xl p-6 text-white shadow-lg">
        <p className="opacity-90">Total Expense</p>
        <p className="mt-2">${totalExpense.toFixed(2)}</p>
      </div>

      {/* Add Expense Form */}
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        <h3 className="mb-6">Add New Expense</h3>
      ...
      {/* Recent Expenses */}
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        <h3 className="mb-6">Recent Expenses</h3>
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    ...
                    style={{
                      backgroundColor: categories.find(c => c.name === transaction.category)?.color + '20' || '#ef444420',
                    }}
                  >
                    <TrendingDown className="w-5 h-5" style={{
                      color: categories.find(c => c.name === transaction.category)?.color || '#ef4444',
                    }} />
                  </div>
                  <div>
                ...
                {deleteTransaction && (
                  <button
                    ...
                    onClick={() => deleteTransaction(transaction.id, 'expense')}
                  >
